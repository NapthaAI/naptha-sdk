...
class Orchestrator:
    ...
    async def run(self, module_run_input: OrchestratorRunInput, secrets: List[SecretInput] = [], *args, **kwargs):
        ...
        orchestrator_run = await node.run_module(module_type="orchestrator", run_input=module_run_input, secrets=secrets)
