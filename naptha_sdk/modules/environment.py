from naptha_sdk.client.node import UserClient, NodeClient
...
class Environment:
    def __init__(self, environment_deployment: EnvironmentDeployment):
        ...
        self.environment_node = UserClient(self.environment_deployment.node)
        self.agent_environment_node = NodeClient(self.environment_deployment.agent_node)
    ...
    async def call_environment_func(self, environment_run_input: EnvironmentRunInput):
        ...
        environment_run = await self.agent_environment_node.run_module(module_type="environment", run_input=environment_run_input)
