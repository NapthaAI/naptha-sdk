...
def agent(name):
    def decorator(func):
        ...
        param_str = scrape_func_params(func)
        ...
        agent_code = render_agent_code(name, agent_code, obj_name, local_modules, selective_import_modules, standard_import_modules, variable_modules, param_str)
