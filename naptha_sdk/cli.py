...
async def main():
    ...
    async with naptha as naptha:
        ...
        if args.command == "signup":
        ...
        elif args.command in ["nodes", "agents", "orchestrators", "environments", "personas", "run", "read_storage", "write_storage", "publish", "create"]:
            ...
            if args.command == "nodes":
                ...
                await create(naptha, args.agent, args.environment_nodes)
